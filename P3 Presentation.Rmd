...
- A Jupyter Python notebook used to scrape data:
  ...
  1. Ran search on Dice.com for Data Scientists jobs
  
  2. Looped thru the Results Page(s) and scrape individual Job Listing URLs

  3. Looped thru Individual Job Listing Pages and scrape job skill(s)
