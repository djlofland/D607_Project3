...
- A Jupyter Python notebook was used to scrape this data:
  ...
  - Looped through the Results Page(s) and scrape individual Job Listing URLs

  - Looped through Individual Job Listing Pages and scrape job skill(s)
...
where he listed his main desiderata for new data science hires.
...
**pursuasion** skills are key in becoming a good data scientist. He concludes
